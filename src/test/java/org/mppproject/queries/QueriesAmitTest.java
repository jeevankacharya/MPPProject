...
public class QueriesAmitTest {
    ...
    private static Order order2 = new Order(2, customer2, salesman4, LocalDate.of(2012, 2, 21), itemList2);
    ...
    private static Order order5 = new Order(5, customer5, salesman3, LocalDate.of(2012, 2, 21), itemList5);
    ...
    @Test
    public void getCustomersAndSalesmenSameCityTest() {

        ArrayList<String> test = new ArrayList<>();
        test.add("Jeevan and James Hong are from New York");
        test.add("Hanok and Adam BC are from London");
        test.add("Sameer and Pit Bull are from Paris");
    ...
    @Test
    public void getTotalSalesmenPerCityTest() {
        ArrayList<String> test = new ArrayList<>();
        test.add("There are total 1 salesman from New York");
        test.add("There are total 1 salesman from Turkey");
        test.add("There are total 1 salesman from Kathmandu");
        test.add("There are total 1 salesman from London");
        test.add("There are total 2 salesman from Paris");

        List<String> lst = QueriesAmit.getTotalSalesmenPerCity(orderList);
    ...
    @Test
    public void uniqueCustomersPerCityTest() {
        String city = "New York";
        List<Customer> str = QueriesAmit.uniqueCustomersPerCity(city, orderList);

        assertEquals("Jeevan", str.get(0).getName());
